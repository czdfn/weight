 ...
 * 前测数据查看.
 */
public class ConstantMeasureFragment extends BaseFragment {
    ...
    Runnable mQueryData = new Runnable() {
        ...
        public void run() {
            ...
            cursor = db.rawQuery("select * from weightcalc where ship_name=? And check_id=? And check_type=?", new String[]{SearchActivity.shipName, measureId + "", 4 + ""});
            mData = new HashMap<>();
            if (cursor != null) {
...
//                    check_id = cursor.getString(cursor.getColumnIndex("check_id"));
    ...
    public View getContentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_constant_measure, null);
        initData();
        return view;
    }
    ...
    public ConstantMeasureFragment() {
    ...
    private void initView() {
        ...
        ((TextView) view.findViewById(R.id.tv16)).setText(mData.get("near_weight") == null ? "000.000" : mData.get("tpc"));
        ...
        ((TextView) view.findViewById(R.id.tv28)).setText(mData.get("qz") == null ? "000.000" : mData.get("qz"));
        ((TextView) view.findViewById(R.id.tv29)).setText(mData.get("cs") == null ? "000.000" : mData.get("cs"));
        ...
        ((TextView) view.findViewById(R.id.tvv21)).setText(new DecimalFormat("0.000").format(jianchuanyongwuliao));
