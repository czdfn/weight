 ...
 * 前测数据查看.
 */
public class BeforeMeasurementFragment extends BaseFragment {
...
//                    check_id = cursor.getString(cursor.getColumnIndex("check_id"));
    ...
    public View getContentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_before_measure_read, null);
        initData();
        return view;
    }
    ...
    public BeforeMeasurementFragment() {
