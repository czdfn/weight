...
//                    kongzhizongliang = cursor.getString(cursor.getColumnIndex("kongzhizongliang"));
    ...
    private void initView() {
        ...
        ((TextView) view.findViewById(R.id.tv4)).setText(mData.get("ceshishuichi_frontLeft") == null ? "0.00" : mData.get("ceshishuichi_frontLeft"));
        ((TextView) view.findViewById(R.id.tv5)).setText(mData.get("ceshishuichi_frontRight") == null ? "0.00" : mData.get("ceshishuichi_frontRight"));
        ((TextView) view.findViewById(R.id.tv6)).setText(mData.get("ceshishuichi_midLeft") == null ? "0.00" : mData.get("ceshishuichi_midLeft"));
        ((TextView) view.findViewById(R.id.tv7)).setText(mData.get("ceshishuichi_midRight") == null ? "0.00" : mData.get("ceshishuichi_midRight"));
        ((TextView) view.findViewById(R.id.tv8)).setText(mData.get("ceshishuichi_backLeft") == null ? "0.00" : mData.get("ceshishuichi_backLeft"));
