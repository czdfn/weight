...
public class BackMeasurementFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        ((TextView) view.findViewById(R.id.tvv24)).setText(new DecimalFormat("0.000").format(shijipaishuiliang_back));
        ((TextView) view.findViewById(R.id.tvv25)).setText(new DecimalFormat("0.000").format(jianchuanyongwuliao_back));
        ((TextView) view.findViewById(R.id.tvv26)).setText(new DecimalFormat("0.000").format(jianqingzai_beiliao));
        ((TextView) view.findViewById(R.id.tvv27)).setText(new DecimalFormat("0.000").format(qingzaijidingliangbeiliao));
        ((TextView) view.findViewById(R.id.tvv28)).setText(new DecimalFormat("0.000").format(qiancepsl));
        ((TextView) view.findViewById(R.id.tvv29)).setText(new DecimalFormat("0.000").format(qiancecywl));
