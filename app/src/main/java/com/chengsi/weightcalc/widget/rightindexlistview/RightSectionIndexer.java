...
public class RightSectionIndexer implements SectionIndexer {
	...
	public RightSectionIndexer(List<HospitalBean> contacts) {
	...
	public void initPositions(List<HospitalBean> contacts) {
		...
		for (HospitalBean contact : contacts) {

			String indexableItem = contact.getServiceItem();
