...
public class FrontMeasureActivity extends BaseActivity implements TextWatcher,TextView.OnEditorActionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_front_measure);
    ...
    public boolean initData() {
        if (!pattern.matcher(editText4.getText().toString()).matches()
            ...
            ds = new DecimalFormat("0.0").format(Double.valueOf(editText24.getText().toString().trim().equals("")?"0":editText24.getText().toString().trim()));
    ...
    private void initView() {
        ...
        editText28.setText(mData.get("qz"));
        editText29.setText(mData.get("cs"));
