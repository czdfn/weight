...
public class CheckInforWebActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_infor_web);
        showToolbar();
        Log.i("FILEPATH", getFilesDir().getAbsolutePath());
        setMyTitle("检查结果");
        String token = getIntent().getStringExtra("token");
        String url = "http://www.haoyunt.com/MpWechat/hollybeacon/weixin/information/checkinfo.jsp?token="+token;
        webview = (WebView)findViewById(R.id.checkinfor_webview);
        initWebView();
