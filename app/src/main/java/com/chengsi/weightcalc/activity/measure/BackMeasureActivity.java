...
//            cv.put("weight_package", new DecimalFormat("0.000").format(weight_package));
    ...
    private void calc() {
        if (initData()) {
            ...
            textView22.setText(String.valueOf(new DecimalFormat("0.0").format(weight_package)));
            textView24.setText(String.valueOf(new DecimalFormat("0.000").format(shijipaishuiliang_back)));
            textView25.setText(String.valueOf(new DecimalFormat("0.000").format(jianchuanyongwuliao_back)));
            textView26.setText(String.valueOf(new DecimalFormat("0.000").format(qingzaijidingliangbeiliao)));
            textView27.setText(String.valueOf(new DecimalFormat("0.000").format(qingzaijidingliangbeiliao)));
            textView28.setText(String.valueOf(new DecimalFormat("0.000").format(qiancepsl)));
            textView29.setText(String.valueOf(new DecimalFormat("0.000").format(qiancecywl)));
            editText4.setText(ceshishuichi_frontLeft);
            editText5.setText(ceshishuichi_frontRight);
            editText6.setText(ceshishuichi_midLeft);
            editText7.setText(ceshishuichi_midRight);
