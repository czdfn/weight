...
//    TextView textView21;
    ...
    public boolean initData() {
        if (!pattern.matcher(editText4.getText().toString()).matches()
            ...
            shijipaishuiliang_front = new DecimalFormat("0.000").format(Double.valueOf(editText28.getText().toString().trim().equals("")?0:Double.valueOf(editText28.getText().toString().trim())));
            jianchuanyongwuliao_front = new DecimalFormat("0.000").format(Double.valueOf(editText29.getText().toString().trim().equals("")?0:Double.valueOf(editText29.getText().toString().trim())));
...
//            textView21.setText(String.valueOf(new DecimalFormat("0.000").format(jianchuanyongwuliao)));
            ...
            textView24.setText(String.valueOf(new DecimalFormat("0.000").format(weight_after)));
            textView25.setText(String.valueOf(new DecimalFormat("0.000").format(jianchuanyongwuliao)));
            textView26.setText(String.valueOf(new DecimalFormat("0.000").format(weight_after-jianchuanyongwuliao)));
            textView27.setText(String.valueOf(new DecimalFormat("0.000").format(weight_after-jianchuanyongwuliao)));
